...
export default function ComputeSidebar({
  ...
  const selectedOpsOpId = searchParams.get("op");
  const selectedTheoryOpId = searchParams.get("op");
          ...
          {isOps && (
            <>
              ...
              {Object.keys(allOpsData).map((id) => {
                const isSelected = selectedOpsOpId === id;
          ...
          {isTheory && (
            <>
              ...
              {Object.keys(theoryByOpId).map((id) => {
                const isSelected = selectedTheoryOpId === id;
