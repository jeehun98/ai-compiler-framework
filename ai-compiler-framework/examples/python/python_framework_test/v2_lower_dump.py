...
from aicf_fw.core_v2 import trace_ir, dump_ir, lower_to_backend_ops, dump_lowered
...
def main():
    ...
    ir = trace_ir(step_fn, name="v2_stage2")
    lowered = lower_to_backend_ops(ir)

    print(dump_ir(ir))
    print("")
    print(dump_lowered(lowered, title="LoweredOps(v2_stage2)"))
