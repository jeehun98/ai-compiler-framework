...
// 각 op launcher.cu에서 제공할 factory 함수 선언
...
extern "C" void aicf_cuda_register_all_kernels() {
  ...
  R.register_kernel(OpKind::EltwiseAdd, make_eltwise_add_f32_variant());
  R.register_kernel(OpKind::EltwiseRelu, make_eltwise_relu_f32_variant());
